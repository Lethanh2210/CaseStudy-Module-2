...
export class StudentManager {
    ...
    addStudent(id: number, name: string, grade: string, phone: string, address: string, point: number): void {
        if (!JSON.parse(localStorage.getItem('student'))) {
            let student: Student = new Student(id, name, grade, phone, address, point);
